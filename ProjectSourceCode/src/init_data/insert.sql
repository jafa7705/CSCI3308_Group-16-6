...
(1, 'Sunset Dreams', '2024-01-05', 'An abstract sunset with warm tones.', 'Painting'),
(2, 'City Reflections', '2023-11-12', 'Nighttime reflections in LA streets.', 'Photography'),
(3, 'Fragments of Thought', '2024-02-20', 'A chaotic composition of shapes.', 'Digital Art'),
(4, 'Bloom', '2024-03-10', 'Detailed study of a blooming flower.', 'Illustration'),
(5, 'The Last Light', '2023-12-01', 'A lonely mountain at dusk.', 'Painting'),
(6, 'Pixel Storm', '2024-01-18', 'A colorful digital storm.', 'Digital Art'),
(7, 'Form in Space', '2023-10-27', 'A 3D sculpture playing with shadows.', 'Sculpture'),
(8, 'Collapse', '2024-02-14', 'Installation of falling chairs.', 'Installation'),
(9, 'The Alleyway', '2023-11-30', 'Candid moment from city backstreets.', 'Photography'),
(10, 'Waves of Color', '2024-03-05', 'Experimental visual series.', 'Painting');
